 ...
 */
public class UserControllerProxyExtends extends UserController {

    /** 这里去依赖注入下MetricsController*/
    private MetricsCollector metricsCollector;

    public UserControllerProxyExtends() {
...
class Test1{
    public static void main(String[] args) {
        ...
        UserControllerProxyExtends userControllerProxy = new UserControllerProxyExtends();
    }
}
